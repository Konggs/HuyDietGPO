...
local function GUI()
    ...
    TimeLabel.Position               = UDim2.new(0.5, 0, 0.85, 0)
            ...
            pcall(function()
                ...
                if #npcs == 0 then
                    ...
                    for _, npc in ipairs(npcs) do
                        ...
                        if hum then
                            lbl.Text = string.format("%s [%d/%d]", npc.Name, math.floor(hum.Health), math.floor(hum.MaxHealth))
                        else
                            lbl.Text = npc.Name .. " [No HP Info]"
                        end
                        lbl.TextColor3      = Color3.fromRGB(0, 0, 0)  -- chữ đen
                        lbl.TextSize        = 18
